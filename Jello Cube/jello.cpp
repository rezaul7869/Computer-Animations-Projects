...
//custom sphere and cylinder details
double cylinderHeight, cylinderBase, nslices, nstacks, sphereRadius;
point cylinderPos, spherePos;
...
int shear=0, bend=0, structural=1, pause=0, viewingMode=0, saveScreenToFile=0, dispGeometry = 0, singleFrame = 0;

// Position of cube with reference to inclined plane, so that cube on positive side always stay on positive side and vice versa
int OriginalPos;

//External Force added when mouse is dragged
point externalForce ={0,0,0};
...
void myinit()
{
  ...
  //Setting Initial values for custom geometries
  cylinderHeight = 2.0f;
  cylinderBase = 0.4f;
  nslices = 32;
  nstacks = 32;
...
void display()
{
  ...
  */
  ...
  GLfloat lKa1[] = { 0.0, 0.0, 0.2, 1.0 };
  GLfloat lKd1[] = { 1.0, 0.0, 0.0, 1.0 };
  GLfloat lKs1[] = { 1.0, 0.0, 0.0, 1.0 };

  GLfloat lKa2[] = { 0.0, 0.0, 0.2, 1.0 };
  GLfloat lKd2[] = { 1.0, 0.5, 0.0, 1.0 };
  GLfloat lKs2[] = { 0.3, 0.2, 0.0, 1.0 };

  GLfloat lKa3[] = { 0.0, 0.0, 0.2, 1.0 };
  GLfloat lKd3[] = { 0.0, 1.0, 1.0, 1.0 };
  GLfloat lKs3[] = { 0.0, 1.0, 0.3, 1.0 };

  GLfloat lKa4[] = { 0.0, 0.0, 0.2, 1.0 };
  GLfloat lKd4[] = { 0.0, 0.0, 0.4, 1.0 };
  GLfloat lKs4[] = { 0.0, 0.0, 0.5, 1.0 };

  GLfloat lKa5[] = { 0.0, 0.0, 0.2, 1.0 };
  GLfloat lKd5[] = { 0.6, 1.0, 0.4, 1.0 };
  GLfloat lKs5[] = { 0.5, 1.0, 0.5, 1.0 };

  GLfloat lKa6[] = { 0.0, 0.0, 0.2, 1.0 };
  GLfloat lKd6[] = { 1.0, 1.0, 1.0, 1.0 };
  GLfloat lKs6[] = { 1.0, 1.0, 0.3, 1.0 };

  GLfloat lKa7[] = { 0.0, 0.0, 0.2, 1.0 };
  GLfloat lKd7[] = { 0.0, 1.0, 1.0, 1.0 };
  GLfloat lKs7[] = { 0.0, 0.5, 1.0, 1.0 };
  ...
  GLfloat mKa[] = { 0.4, 0.3, 0.2, 1.0 };
  GLfloat mKd[] = { 0.4, 0.4, 0.4, 0.0 };
...
void doIdle()
{
  ...
  if(showPerformance == 1) printf("%f\n",1000/currentTime); //Getting around 55-60 fps in Dual Core
...
int main (int argc, char ** argv)
{
  ...
  {  
    ...
    printf ("Usage: %s [worldfile] [EnableGeometryAndMouseDrag = 1]\n", argv[0]);
    exit(0);
  }
  ...
  if(argc >2)
  {
	  ...
	  dispGeometry = (input == 1) ? 1 : 0; 
  }

  point centerPosition = {0,0,0};
  double centerPosToPlane = ((jello.a * centerPosition.x +
				jello.b * centerPosition.y +
				jello.c * centerPosition.z +
				jello.d) > 0);
  OriginalPos = (centerPosToPlane == 0)? 0 :((centerPosToPlane > 0)? 1 : -1);
