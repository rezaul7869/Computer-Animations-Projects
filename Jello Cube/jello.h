...
extern double cylinderHeight, cylinderBase, nslices, nstacks, sphereRadius;
extern int showPerformance;
...
extern point cylinderPos, spherePos;
extern int pInclinedPlaneCalculated;
extern int nIntersections;
extern float cornerLocation[8][3];


// these variables control what is displayed on the screen
extern int shear, bend, structural, pause, viewingMode, saveScreenToFile, dispGeometry, singleFrame;
extern point externalForce;
extern int OriginalPos;
