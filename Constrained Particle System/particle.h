...
extern int pause, viewingMode, saveScreenToFile, singleFrame, No_Of_Particles, forceMode, rotateCamera, externalForce, cRing;
//extern int shear, bend, structural;
...
struct world
{
  int integrator; // " 1 = RK4" or "0 = Euler"
  ...
  struct point* p; // position of the NO_OF_PARTICLES particles
  struct point* v; // velocities of the NO_OF_PARTICLES particles
  struct point* force; // velocities of the NO_OF_PARTICLES particles
  struct Disk disk;
  double alpha;
  double beta;
  int nParticles;
